...
def scrape(url):
    '''scrape(url) - scrape book <url> (starting with /) from qudaisozi.com,
return Book object, or None on error'''
    ...
    try:
        ...
        return classes.Book(book_name, [chapter for chapter in chapters if chapter is not None])
